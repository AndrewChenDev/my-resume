  ...
  main: [
    {
      ...
      tasks: [
        ...
        "Built driver signup page and Lambda backend services, owning the full stack from UI to cloud deployment",
        ...
        "Led internal initiative to integrate AI into the engineering workflow — researched and implemented Claude, Codex, MCP servers, agent teams, and RAG systems to reduce developer overhead and accelerate delivery",
  ...
  logo: [
    {
      ...
      subText: "Burnaby, BC",
      tasks: [
        "Developed and maintained fullstack applications using TypeScript, React (Next.js), PHP, and SQL",
        "Utilized Next.js server-side rendering and caching techniques, leading to a 300% decrease in load time for web applications",
    ...
    Ace1Media:[
        {
            ...
            tasks: [
                ...
                "Integrated Deliverect POS API to expand restaurant partner capabilities and streamline order management workflows",
                // "Refactored legacy codebase exceeding 80,000 lines using AI-assisted development tools (Claude Code, Codex) to boost maintainability and accelerate feature delivery"
            ],
        },
        {
            title: "Full Stack Developer",
